...
| `DIRECCION` | Dirección física informada por el establecimiento. | Texto (`string`) | Texto normalizado o `NA`. | 7,433 valores no nulos observados; 87 registros `NA`. | Puntos usados como ausencia pasaron a `NA`; se normalizaron Unicode, mayúsculas y espacios sin geocodificar. | No aplica. | 2026-07-18 | MINEDUC | `v0.1.0-candidato` |
...
| `SUPERVISOR` | Nombre del supervisor educativo informado. | Texto (`string`) | Texto normalizado o `NA`. | 1,280 valores no nulos observados; 536 registros `NA`. | Se unificaron Unicode, mayúsculas y espacios; se conservaron tildes y no se fusionaron personas por similitud. | No aplica. | 2026-07-18 | MINEDUC | `v0.1.0-candidato` |
| `DIRECTOR` | Nombre del director informado. | Texto (`string`) | Texto normalizado o `NA`. | 5,493 valores no nulos observados; 2,138 registros `NA`. | `SIN DATO`, puntos y cadenas formadas solo por guiones se convirtieron a `NA`; se normalizó el texto restante. | No aplica. | 2026-07-18 | MINEDUC | `v0.1.0-candidato` |
